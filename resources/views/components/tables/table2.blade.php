                        ...
                        <td class="px-5 py-4 sm:px-6">
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <form action="{{ route('user.destroy', $user->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-gray-500 transition hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500" title="Hapus" onclick="return confirm('Apakah kamu ingin menghapus user ini?')">
                                ...
                                {{-- Edit --}}
                                <button type="button" class="text-gray-500 transition hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90" title="Edit">
                                    <svg class="fill-current" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
