                            ...
                            <form method="post" action="{{ route('loginProses') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        @error('username') !border-red-500 !focus:border-red-500 !focus:ring-red-500/10 @enderror" value="{{ old('username') }}"/>
                                        @error('username')
                                    ...
                                    <div>
                                        <button class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition" type="submit">
                                            Log In
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Log In untuk melanjutkan ke dashboard Kas Laravel
                        </p>
                    </div>
                </div>
            </div>
